...
class ForumController extends \BaseController {
	...
	protected $posts;
	protected $user;
	public $section = 'forum';
	public $resource_key = 'forum';
	public $resource_permission = 'view_forum';
	...
	{
		// Manual check to see if user is logged in
		// as routes are set by package
		if (Auth::guest())
		{
			return false;
		}
