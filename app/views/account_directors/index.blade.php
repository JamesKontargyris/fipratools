...
@section('page-header')
	@if(is_search())
		<i class="fa fa-search"></i> Searching for {{ Session::has('account_directors.SearchType') ? Session::get('account_directors.SearchType') : '' }}: {{ $items->search_term }}
	@else
		Account Directors Overview
	@endif
@stop
