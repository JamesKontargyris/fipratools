...
@section('page-nav')
    <li><a href="{{ url('/survey/profile/edit') }}" class="primary"><i class="fa fa-pencil"></i> Update your Knowledge Profile</a></li>
@stop
                    ...
                    <table width="100%" class="index-table">
                        ...
                        <tr class="hide-print hide-m">
                            ...
                            @foreach($area_groups as $group)
                                <td class="hide-m sub-header">
                                    {{ Form::open(['url' => 'survey/search']) }}
                                    {{ Form::select('filter_value', $areas[$group->id], Session::has('survey.Filters.knowledge_area_id') ? Session::get('survey.Filters.knowledge_area_id') : null, ['class' => 'list-table-filter select2', 'style' => 'width:100%']) }}
