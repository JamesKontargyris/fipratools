...
@section('content')
    ...
    {{ get_widget('head_of_unit_survey_intro') }}
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('unit_staff_public_affairs_government_relations', 'How many people in your Unit are MAINLY dedicated to the following areas:', ['class' => 'required']) }}
            </div>
        </div>
            ...
            <div class="formfield">
                <table cellspacing="5" cellpadding="5" border="0" width="100%" class="survey-entry-table">
                    <thead>
                        <tr>
                            <td width="70%">Area</td>
                            <td width="30%">No. of People</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="font-size:16px;">Public Affairs / Government Relations</td>
                            <td>{{ Form::text("unit_staff_public_affairs_government_relations", Input::has('unit_staff_public_affairs_government_relations') ? Input::get('unit_staff_public_affairs_government_relations') : isset($hou_survey_data['unit_staff_public_affairs_government_relations']) ? $hou_survey_data['unit_staff_public_affairs_government_relations'] : '') }}</td>
                        </tr>
                        <tr>
                            <td style="font-size:16px;">Financial Public Relations</td>
                            <td>{{ Form::text("unit_staff_financial_public_relations", Input::has('unit_staff_financial_public_relations') ? Input::get('unit_staff_financial_public_relations') : isset($hou_survey_data['unit_staff_financial_public_relations']) ? $hou_survey_data['unit_staff_financial_public_relations'] : '') }}</td>
                        </tr>
                        <tr>
                            <td style="font-size:16px;">Other Public Relations</td>
                            <td>{{ Form::text("unit_staff_other_public_relations", Input::has('unit_staff_other_public_relations') ? Input::get('unit_staff_other_public_relations') : isset($hou_survey_data['unit_staff_other_public_relations']) ? $hou_survey_data['unit_staff_other_public_relations'] : '') }}</td>
                        </tr>
                        <tr>
                            <td style="font-size:16px;">Personal and Administrative Support / Finance / Accountancy (full-time and non-fee earning)</td>
                            <td>{{ Form::text("unit_staff_personal_and_administrative_support_finance_accountancy", Input::has('unit_staff_personal_and_administrative_support_finance_accountancy') ? Input::get('unit_staff_personal_and_administrative_support_finance_accountancy') : isset($hou_survey_data['unit_staff_personal_and_administrative_support_finance_accountancy']) ? $hou_survey_data['unit_staff_personal_and_administrative_support_finance_accountancy'] : '') }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('unit_staff_total', 'Total number of staff in your Unit:', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                {{ Form::text("unit_staff_total", Input::has('unit_staff_total') ? Input::get('unit_staff_total') : isset($hou_survey_data['unit_staff_total']) ? $hou_survey_data['unit_staff_total'] : '', ['style' => 'width:30%']) }}
            </div>
        </div>
    </div>
    <hr>
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('unit_staff_part_time_outside_consultants', 'Does your Unit regularly use part-time staff or outside consultants in addition to those above?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('unit_staff_positions_in_public_office', 'Do any of the persons above currently hold any positions in government or public office including regulatory and judiciary appointments?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                    ...
                    <li class="question-details no-left-pad unit_staff_positions_in_public_office_details">
                        ...
                        <table cellpadding="5" cellspacing="0" border="0" class="survey-entry-table unit_staff_positions_in_public_office_people">
                            ...
                            @else
                                <!--First proper row-->
                                <tr>
                                    <td>{{ Form::text("unit_staff_positions_in_public_office_people[0][name]", null) }}</td>
                                    <td>{{ Form::text("unit_staff_positions_in_public_office_people[0][position]", null) }}</td>
                                    <td>{{ Form::text("unit_staff_positions_in_public_office_people[0][from]", null) }}</td>
                                </tr>
                            @endif
                            </tbody>
                        </table>
                        <a href="#" class="secondary but-small entry-table-new-row-button" data-no-of-rows="1" data-target-table=".unit_staff_positions_in_public_office_people">Add a row</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="formfield">
                <table cellpadding="5" cellspacing="0" border="0" width="100%" class="survey-entry-table unit_staff_carrying_out_public_affairs">
                    ...
                    @else
                        <!--First proper row-->
                        <tr>
                            <td>{{ Form::text("unit_staff_carrying_out_public_affairs[0][name]", null) }}</td>
                            <td>{{ Form::select("unit_staff_carrying_out_public_affairs[0][seniority]", $seniority, null) }}</td>
                        </tr>
                    @endif
                    </tbody>
                </table>
                <a href="#" class="secondary but-small entry-table-new-row-button" data-no-of-rows="1" data-target-table=".unit_staff_carrying_out_public_affairs">Add a row</a>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('unit_staff_previously_held_public_office_senior_positions_in_trade_consumer_organisations', 'Including outside consultants you may use, how many of your total staff above have previously held public office or senior positions in trade or consumer organisations?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('points_of_contact', 'Who should be listed on the Network\'s website, www.fipra.com, and other internal and external marketing materials as the main points of contact for your Unit / country for both potential clients and other Fipra colleagues?', ['class' => 'required']) }}
        ...
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    <li>{{ Form::radio('points_of_contact', 'Me and the person(s) listed below', Input::has('points_of_contact') ? Input::get('points_of_contact') : (isset($hou_survey_data['points_of_contact']) && $hou_survey_data['points_of_contact'] == 'Me and the person(s) listed below') ? 1 : 0) }} Me and the person(s) listed below</li>
                    <li>{{ Form::radio('points_of_contact', 'The person(s) listed below', Input::has('points_of_contact') ? Input::get('points_of_contact') : (isset($hou_survey_data['points_of_contact']) && $hou_survey_data['points_of_contact'] == 'The person(s) listed below') ? 1 : 0) }} The person(s) listed below</li>
                </ul>
                <br>
                <table cellpadding="5" cellspacing="0" border="0" width="100%" class="survey-entry-table points_of_contact_people">
                    ...
                    <!--Blank row that is inserted when the button is pressed-->
                    <tr class="entry-table-repeatable-row" style="display:none;">
                        <td>{{ Form::text("points_of_contact_people[999][name]", null, ['disabled' => 'disabled', 'class' => 'name-field']) }}</td>
                        <td><a href="#" class="remove-repeatable-row"><i class="fa fa-close"></i></a></td>
                    </tr>
                    ...
                    @if(Input::old('points_of_contact_people'))
                        @foreach(Input::old('points_of_contact_people') as $id => $value)
                            <tr>
                                <td>{{ Form::text("points_of_contact_people[$id][name]", Input::get("points_of_contact_people.$id.name")) }}</td>
                                @if($id > 0) <td><a href="#" class="remove-repeatable-row"><i class="fa fa-close"></i></a></td>@endif
                            </tr>
                        @endforeach
                    @elseif(isset($hou_survey_data['points_of_contact_people']))
                        @foreach($hou_survey_data['points_of_contact_people'] as $id => $staff_member_info)
                            <tr>
                                <td>{{ Form::text("points_of_contact_people[$id][name]", $staff_member_info['name']) }}</td>
                                @if($id > 0)
                                    <td><a href="#" class="remove-repeatable-row"><i class="fa fa-close"></i></a></td>
                                @else
                                    <td></td>
                    ...
                    @else
                        <!--First proper row-->
                        <tr>
                            <td>{{ Form::text("points_of_contact_people[0][name]", null) }}</td>
                        </tr>
                    @endif
                    </tbody>
                </table>
                <a href="#" class="secondary but-small entry-table-new-row-button" data-no-of-rows="1" data-target-table=".points_of_contact_people">Add a row</a>
            </div>
        </div>
    </div>
    <hr>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('website_reciprocal_link', 'Does your website state its affiliation to the Fipra Network and / or provide a reciprocal link to www.fipra.com?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('online_social_media_policy', 'Does your Unit have an online / social media policy?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    <li>{{ Form::radio('online_social_media_policy', 'Yes', Input::has('online_social_media_policy') ? Input::get('online_social_media_policy') : (isset($hou_survey_data['online_social_media_policy']) && $hou_survey_data['online_social_media_policy'] == 'Yes') ? 1 : 0) }} Yes &nbsp;&nbsp;&nbsp;{{ Form::radio('online_social_media_policy', 'No', Input::has('online_social_media_policy') ? Input::get('online_social_media_policy') : (isset($hou_survey_data['online_social_media_policy']) && $hou_survey_data['online_social_media_policy'] == 'No') ? 1 : 0) }} No</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details online_platform_twitter_details">
                        ...
                        {{ Form::text('online_platform_twitter_details', Input::has('online_platform_twitter_details') ? Input::get('online_platform_twitter_details') : isset($hou_survey_data['online_platform_twitter_details']) ? $hou_survey_data['online_platform_twitter_details'] : '', ['placeholder' => 'www.twitter.com/name', 'style' => 'width:70%', 'class' => 'url-format']) }}
                    </li>
                    ...
                    <li class="question-details online_platform_facebook_details">
                        ...
                        {{ Form::text('online_platform_facebook_details', Input::has('online_platform_facebook_details') ? Input::get('online_platform_facebook_details') : isset($hou_survey_data['online_platform_facebook_details']) ? $hou_survey_data['online_platform_facebook_details'] : '', ['placeholder' => 'www.facebook.com/url', 'style' => 'width:70%', 'class' => 'url-format']) }}
                    </li>
                    ...
                    <li class="question-details online_platform_linkedin_details">
                        ...
                        {{ Form::text('online_platform_linkedin_details', Input::has('online_platform_linkedin_details') ? Input::get('online_platform_linkedin_details') : isset($hou_survey_data['online_platform_linkedin_details']) ? $hou_survey_data['online_platform_linkedin_details'] : '', ['placeholder' => 'www.linkedin.com/url', 'style' => 'width:70%', 'class' => 'url-format']) }}
                    </li>
                    ...
                    <li class="question-details online_platform_youtube_details">
                        ...
                        {{ Form::text('online_platform_youtube_details', Input::has('online_platform_youtube_details') ? Input::get('online_platform_youtube_details') : isset($hou_survey_data['online_platform_youtube_details']) ? $hou_survey_data['online_platform_youtube_details'] : '', ['placeholder' => 'www.youtube.com/url', 'style' => 'width:70%', 'class' => 'url-format']) }}
                    </li>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('online_newsletters', 'Does your Unit produce regular internal or external online newsletters?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('annual_sales_turnover', 'What was your Unit\'s annual sales / turnover in the last full calendar year?', ['class' => 'required']) }}
        ...
        <div class="col-7 last">
            <div class="formfield">
                &euro; {{ Form::text("annual_sales_turnover", Input::has('annual_sales_turnover') ? Input::get('annual_sales_turnover') : isset($hou_survey_data['annual_sales_turnover']) ? $hou_survey_data['annual_sales_turnover'] : '', ['style' => 'width:50%']) }}
            </div>
        </div>
    </div>
    <hr>
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('percentage_of_turnover_related_to_public_affairs', 'What percentage (%) of your total turnover do you estimate relates to the Public Affairs/Government Relations part of your business?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('turnover_forecast', 'According to your forecast for this year, your Public Affairs turnover / sales will:', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('member_other_branded_network', 'Is your Unit a member of any other branded Public Affairs or Public Relations Network other than the Fipra Network?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad member_other_branded_network_details">
                        ...
                        {{ Form::textarea('member_other_branded_network_details', Input::has('member_other_branded_network_details') ? Input::get('member_other_branded_network_details') : isset($hou_survey_data['member_other_branded_network_details']) ? $hou_survey_data['member_other_branded_network_details'] : '', ['rows' => '4']) }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('member_professional_association', 'Is your Unit a member of a professional association?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad member_professional_association_details">
                        Please give further details:
                        {{ Form::textarea('member_professional_association_details', Input::has('member_professional_association_details') ? Input::get('member_professional_association_details') : isset($hou_survey_data['member_professional_association_details']) ? $hou_survey_data['member_professional_association_details'] : '', ['rows' => '4']) }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('mandatory_public_register', 'Is it mandatory in your country for your Unit or your staff to appear on a public register of public affairs professionals or lobbyists?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad mandatory_public_register_details">
                        Please give further details:
                        {{ Form::textarea('mandatory_public_register_details', Input::has('mandatory_public_register_details') ? Input::get('mandatory_public_register_details') : isset($hou_survey_data['mandatory_public_register_details']) ? $hou_survey_data['mandatory_public_register_details'] : '', ['rows' => '4']) }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('publicly_list_clients', 'Do you publicly list all or part of your public affairs / government relations clients?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad publicly_list_clients_details">
                        ...
                        {{ Form::textarea('publicly_list_clients_details', Input::has('publicly_list_clients_details') ? Input::get('publicly_list_clients_details') : isset($hou_survey_data['publicly_list_clients_details']) ? $hou_survey_data['publicly_list_clients_details'] : '', ['rows' => '4']) }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('work_from_other_network_in_last_12_months', 'Has your Unit taken any work from any PA/PR brand or Network other than Fipra in the last 12 months?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad work_from_other_network_in_last_12_months_details">
                        Please give details:
                        {{ Form::textarea('work_from_other_network_in_last_12_months_details', Input::has('work_from_other_network_in_last_12_months_details') ? Input::get('work_from_other_network_in_last_12_months_details') : isset($hou_survey_data['work_from_other_network_in_last_12_months_details']) ? $hou_survey_data['work_from_other_network_in_last_12_months_details'] : '', ['rows' => '4']) }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('most_important_trading_partner_last_calendar_year', 'Who was your most important trading partner from the Fipra Network in the last calendar year (' . date('Y', strtotime('last year')) . ')?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('euros_paid_to_other_fipra_network_members_last_year', 'Approximately how many Euros did your Unit pay in total to other members of the Fipra Network in the last calendar year (' . date('Y', strtotime('last year')) . ')?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('euros_received_from_other_fipra_network_members_last_year', 'Approximately how many Euros did your Unit receive in total from other members of the Fipra Network in the last calendar year (' . date('Y', strtotime('last year')) . ')?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('new_clients_signed_up_last_year', 'How many new clients did your Unit sign up in the last calendar year (' . date('Y', strtotime('last year')) . ') in some way due to your involvement with the Fipra Network?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                {{ Form::text("new_clients_signed_up_last_year", Input::has('new_clients_signed_up_last_year') ? Input::get('new_clients_signed_up_last_year') : isset($hou_survey_data['new_clients_signed_up_last_year']) ? $hou_survey_data['new_clients_signed_up_last_year'] : '', ['style' => 'width:30%']) }}
            </div>
        </div>
    </div>
    <hr>
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('top_3_client_obtained_through_fipra_unit', 'Please think of your current top 3 clients. Is one of those clients obtained through another Fipra Unit?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad top_3_client_obtained_through_fipra_unit_details">
                        Please specify who:
                        {{ Form::text('top_3_client_obtained_through_fipra_unit_details', Input::has('top_3_client_obtained_through_fipra_unit_details') ? Input::get('top_3_client_obtained_through_fipra_unit_details') : isset($hou_survey_data['top_3_client_obtained_through_fipra_unit_details']) ? $hou_survey_data['top_3_client_obtained_through_fipra_unit_details'] : '') }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('top_3_local_business_territory_competitors_1', 'Who do you believe are your top 3 competitors in your territory for LOCAL business?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('top_3_international_business_competitors_1', 'Who do you believe are your top 3 competitors for INTERNATIONAL business?', ['class' => 'required']) }}
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('unit_usp', 'What is your Unit\'s Number 1 unique selling point?', ['class' => 'required']) }}
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('fees_operation', 'Which one of these statements applies to your Unit?', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <ul>
                    ...
                    <li>{{ Form::radio('fees_operation', 'We do not work with success fees', Input::has('fees_operation') ? Input::get('fees_operation') : (isset($hou_survey_data['fees_operation']) && $hou_survey_data['fees_operation'] == 'We do not work with success fees') ? 1 : 0, ['class' => 'hide-details-entry']) }} We do not work with success fees</li>
                    <li>{{ Form::radio('fees_operation', 'We work with success fees', Input::has('fees_operation') ? Input::get('fees_operation') : (isset($hou_survey_data['fees_operation']) && $hou_survey_data['fees_operation'] == 'We work with success fees') ? 1 : 0, ['class' => 'hide-details-entry']) }} We work with success fees</li>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('contracts_percentage_retainers', 'What percentage of your contracts are:', ['class' => 'required']) }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
                <table cellspacing="5" cellpadding="5" border="0" class="survey-entry-table">
                    ...
                    <tr>
                        ...
                        <td>{{ Form::text("contracts_percentage_retainers", Input::has('contracts_percentage_retainers') ? Input::get('contracts_percentage_retainers') : isset($hou_survey_data['contracts_percentage_retainers']) ? $hou_survey_data['contracts_percentage_retainers'] : '', ['style' => 'width:30%']) }} %</td>
                    </tr>
                    <tr>
                        <td style="font-size:16px;">Time-based Fees:</td>
                        <td>{{ Form::text("contracts_percentage_time_based_fees", Input::has('contracts_percentage_time_based_fees') ? Input::get('contracts_percentage_time_based_fees') : isset($hou_survey_data['contracts_percentage_time_based_fees']) ? $hou_survey_data['contracts_percentage_time_based_fees'] : '', ['style' => 'width:30%']) }} %</td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('professional_indemnity_insurance', 'Does your Unit have professional indemnity insurance?', ['class' => 'required']) }}
            ...
            <div class="formfield">
                <ul>
                    ...
                    <li class="question-details no-left-pad professional_indemnity_insurance_details">
                        Up to what amount?
                        {{ Form::text('professional_indemnity_insurance_details', Input::has('professional_indemnity_insurance_details') ? Input::get('professional_indemnity_insurance_details') : isset($hou_survey_data['professional_indemnity_insurance_details']) ? $hou_survey_data['professional_indemnity_insurance_details'] : '') }}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row no-margin">
        <div class="col-5">
            <div class="formfield">
                {{ Form::label('hou_survey_feedback', 'Do you have any other strong views or opinions about Fipra that you do not feel were covered by this questionnaire and that you would like to see surveyed next time?') }}
            </div>
        </div>
        <div class="col-7 last">
            <div class="formfield">
    ...
    <div class="row">
        <div class="col-12">
            {{ Form::submit('Complete Survey', ['class' => 'primary']) }}
        </div>
    </div>
