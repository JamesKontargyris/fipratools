...
@section('page-header')
    @if(is_search()) <i class="fa fa-search"></i> Searching for: {{ $items->search_term }} @else Products Overview @endif
@stop

@section('page-nav')
    <li><a href="{{ route('products.create') }}" class="secondary"><i class="fa fa-plus-circle"></i> Add a Product</a></li>
@stop
