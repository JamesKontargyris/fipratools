		...
		<div class="row">
			<div class="col-7">
				<ul class="super-menu">
					...
					<li class="super-menu__item hide-print"><a href="/list?section=survey" class="super-menu__link <?php if(Session::get('section') == 'survey') : ?> active<?php endif; ?>">Knowledge Survey</a></li>
				</ul>
			</div>
