...
@section('page-nav')
<li><a href="{{ route('sectors.create') }}" class="primary"><i class="fa fa-plus-circle"></i> Add a Sector</a></li>
<li><a href="{{ route('sector_categories.index') }}" class="primary"><i class="fa fa-pencil"></i> Manage Expertise Categories</a></li>
@stop
