		...
		<div class="row">
			<div class="col-12">
				<table width="100%" class="index-table">
					<thead>
						<tr>
							<td width="100%">Expertise Category Name</td>
							...
							<tr>
								...
								<td class="actions content-right hide-print">
									{{ Form::open(['route' => array('sector_categories.destroy', $sector_category->id), 'method' => 'delete']) }}
										<button type="submit" class="red-but delete-row" data-resource-type="expertise category"><i class="fa fa-times"></i></button>
									{{ Form::close() }}
								</td>
							</tr>
						@endforeach
